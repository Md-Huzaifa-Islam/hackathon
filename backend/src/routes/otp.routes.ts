...
otpRouter.post("/otp/send", asyncHandler(async (req, res) => {
...
otpRouter.post("/otp/verify", asyncHandler(async (req, res) => {
...
otpRouter.post("/otp/callback", asyncHandler(async (req, res) => {
...
otpRouter.get("/otp/status/:ref", asyncHandler(async (req, res) => {
